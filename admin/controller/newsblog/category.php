...
class ControllerNewsBlogCategory extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['image_size_width'])) {
			...
			$data['image_size_width'] = $this->config->get($this->config->get('config_theme') . '_image_category_width');
		}
		...
		if (isset($this->request->post['image_size_height'])) {
			...
			$data['image_size_height'] = $this->config->get($this->config->get('config_theme') . '_image_category_height');
		}
		...
		if (isset($this->request->post['images_size_width'])) {
			...
			$data['images_size_width'] = $this->config->get($this->config->get('config_theme') . '_image_product_width');
		}
		...
		if (isset($this->request->post['images_size_height'])) {
			...
			$data['images_size_height'] = $this->config->get($this->config->get('config_theme') . '_image_product_height');
		}
		...
		if (isset($this->request->post['images_size_articles_big_width'])) {
			...
			$data['images_size_articles_big_width'] = $this->config->get($this->config->get('config_theme') . '_image_popup_width');
		}
		...
		if (isset($this->request->post['images_size_articles_big_height'])) {
			...
			$data['images_size_articles_big_height'] = $this->config->get($this->config->get('config_theme') . '_image_popup_height');
		}
		...
		if (isset($this->request->post['images_size_articles_small_width'])) {
			...
			$data['images_size_articles_small_width'] = $this->config->get($this->config->get('config_theme') . '_image_thumb_width');
		}
		...
		if (isset($this->request->post['images_size_articles_small_height'])) {
			...
			$data['images_size_articles_small_height'] = $this->config->get($this->config->get('config_theme') . '_image_thumb_height');
		}
