...
class ModelNewsBlogCategory extends Model {
	public function addCategory($data,$settings) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "newsblog_category_path` SET `category_id` = '" . (int)$category_id . "', `path_id` = '" . (int)$category_id . "', `level` = '" . (int)$level . "'");
